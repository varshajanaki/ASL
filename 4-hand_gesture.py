...
model = tf.keras.models.load_model(r'D:\Major Project\model.h5')
model.summary()
data_dir = 'data'
...
while(True):
    _ , frame = cap.read()
    cv2.rectangle(frame, (75, 75), (300, 300), (0, 0, 255), 5) 
    #region of intrest
    ...
    color = (0,255,255)
    thickness = 2
    #writing the predicted character to the frame
    msg = predicted_char 
    cv2.putText(frame, msg, (100, 70), font, fontScale, color, thickness)
